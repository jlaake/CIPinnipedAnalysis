...
```{r,echo=FALSE,fig.width=6,fig.height=7,dpi=600}
plot(SSTDF$SST1,SSTDF$fgr,ylab="Female pup growth rate (kg/day)",xlab="Average sea surface temperature anomaly from Oct-Feb")
```
Figure 2f. Annual female pup growth rates predictions from cross-sectional data with the environment model as a function of average sea surfae temperatuer anomaly from Oct-Feb.
