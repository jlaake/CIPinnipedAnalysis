...
```{r,echo=FALSE,fig.width=7,fig.height=8}
xx=cbind(Year=1975:2015,Fwt=ZCWeight.df$female.adjusted.mean.fall,
...
with(ZCWeight.df[!is.na(ZCWeight.df$female.environ.diet.mean.fall),],plot(Year,female.environ.diet.mean.fall-female.environ.diet.mean.fall.fixed,pch="F",type="b",ylab="Female residuals"))
abline(0,0)
with(ZCWeight.df[!is.na(ZCWeight.df$female.environ.diet.mean.fall),],plot(Year,male.environ.diet.mean.fall-maleenviron.diet.mean.fall.fixed,pch="M",ylab="Male residuals",type="b"))
abline(0,0)
```
