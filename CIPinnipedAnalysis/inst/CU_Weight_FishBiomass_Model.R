...
cu.weight.model.environ.abun=lme(res.environ.abun$best.f,random=res.environ.abun$best.r,data=res.environ.abun$data,control=lmeControl(opt="optim"),method="REML")
