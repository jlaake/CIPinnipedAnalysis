...
#' @return list containing ZcProduction and CuProduction dataframes 
#' @export
#' @author Jeff Laake
do.pup.production=function(fdir=NULL)
{
#
...
return(list(ZcProduction=ZcProduction,CuProduction=CuProduction))
}
